...
```javascript
SQRT_PHI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-phi@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-phi@v0.1.1-umd/browser.js"></script>
```
