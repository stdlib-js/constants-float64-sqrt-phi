...
```javascript
import SQRT_PHI from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-phi@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-sqrt-phi/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/constants-float64-sqrt-phi/actions/workflows/test.yml?query=branch:v0.2.2
